...
def process_data():   
    ...
    pokemon_dir = os.path.join(current_dir, 'GANSdataset')
    images = []
...
def train():
    ...
    d_vars = [var for var in t_vars if 'discriminators' in var.name]
    g_vars = [var for var in t_vars if 'generators' in var.name]
